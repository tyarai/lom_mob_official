...
class _SightingEditPageState extends State<SightingEditPage> {
  ...
  _buildGPSWidget(SightingBloc bloc){
    if(sighting != null) {
      return Container(
        child: Padding(
              ...
              Container(
                  ...
                  Padding(
                    ...
                    child: Column(
                        ...
                        Text("Longitude : ${sighting.longitude}",style: Constants.defaultSubTextStyle,),
                        Container(height: 5,),
                        Text("Latitude  : ${sighting.latitude}",style: Constants.defaultSubTextStyle,),
                        Container(height: 5,),
                        Text("Altitude  : ${sighting.altitude}",style: Constants.defaultSubTextStyle,),
                        Container(height: 5,),
              ]),
                  )),
